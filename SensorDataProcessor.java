public class SensorDataProcessor { 
    ...
    // constructor 
    public SensorDataProcessor(double[][][] data, double[][] limit) { //Fixed be Razan Ibrahim - 2111213 : change constructor to match class name
        this.data = data; 
        this.limit = limit; 
    } 
    ...
    public void calculate(double d) { 
        ...
        int i, j;  //Fixed be Razan Ibrahim - 2111213 : change the variable declaration to initialize k separately
        int k = 0;  //Fixed be Razan Ibrahim - 2111213
        double[][][] data2 = new 
